...
mp_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of mp_radix theme and run the following commands:
`nvm use`
...
`drush en mp_radix -y`
`drush config-set system.theme default mp_radix -y`
